...
# From https://github.com/mcordts/cityscapesScripts/blob/master/cityscapesscripts/evaluation/evalPixelLevelSemanticLabeling.py
# Evaluation of Cityscapes Semantic Segmentation
...
def getPrediction(args, groundTruthFile):
    ...
    args.predictionPath = args.res_dir
...
# The main method
def eval(city_root, res_dir):
    global args
    args.cityscapesPath = city_root
...
if __name__ == '__main__':
    eval(city_root='/root/cityscapes', res_dir='/root/Train/expr/log/results')
